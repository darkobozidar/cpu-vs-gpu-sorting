...
void BitonicSortParallelKeyOnly::runBitoicSortKernel(data_t *d_keys, uint_t arrayLength)
{
...
*/
template <order_t sortOrder>
void BitonicSortParallelKeyOnly::runBitonicMergeGlobalKernel(
...
*/
template <order_t sortOrder>
void BitonicSortParallelKeyOnly::runBitoicMergeLocalKernel(
    data_t *d_keys, uint_t arrayLength, uint_t phase, uint_t step
)
{
...
*/
template <order_t sortOrder>
void BitonicSortParallelKeyOnly::bitonicSortParallelKeyOnly(data_t *d_keys, uint_t arrayLength)
{
