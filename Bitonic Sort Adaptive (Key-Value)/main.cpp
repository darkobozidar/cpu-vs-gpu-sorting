...
int main(int argc, char **argv)
{
    ...
    allocDeviceMemory(
        &d_dataTableKeys, &d_dataTableValues, &d_dataBufferKeys, &d_dataBufferValues, &d_intervals,
    ...
    freeDeviceMemory(
        d_dataTableKeys, d_dataTableValues, d_dataBufferKeys, d_dataBufferValues, d_intervals, d_intervalsBuffer
    );
