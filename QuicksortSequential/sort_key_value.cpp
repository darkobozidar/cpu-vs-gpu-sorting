...
uint_t QuicksortSequential::partitionArray(data_t *h_keys, data_t *h_values, uint_t arrayLength)
{
...
*/
template <order_t sortOrder>
void QuicksortSequential::quicksortSequential(data_t *h_keys, data_t *h_values, uint_t arrayLength)
{
    if (arrayLength <= 1)
    {
        return;
...
*/
void QuicksortSequential::sortKeyValue()
{
