...
)
{
    ...
    else if (degree == 2)
    {
        if (sortOrder == ORDER_ASC)
        {
            multiStep2Kernel<ORDER_ASC><<<dimGrid, dimBlock>>>(keys, values, tableLen, step);
        }
        else
        {
    ...
    else if (degree == 4)
    {
        if (sortOrder == ORDER_ASC)
        {
            multiStep4Kernel<ORDER_ASC><<<dimGrid, dimBlock>>>(keys, values, tableLen, step);
        }
        else
        {
            multiStep4Kernel<ORDER_DESC><<<dimGrid, dimBlock>>>(keys, values, tableLen, step);
        }
    }
    else if (degree == 5)
    {
        if (sortOrder == ORDER_ASC)
        {
            multiStep5Kernel<ORDER_ASC><<<dimGrid, dimBlock>>>(keys, values, tableLen, step);
        }
        else
        {
            multiStep5Kernel<ORDER_DESC><<<dimGrid, dimBlock>>>(keys, values, tableLen, step);
        }
    }
    /*else if (degree == 6)
    {
